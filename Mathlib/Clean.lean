...
theorem absNorm_differentIdeal {K : Type*} [Field K] [NumberField K] :
    Ideal.absNorm (differentIdeal ℤ (𝓞 K)) = |NumberField.discr K| := by
  sorry
...
-- That's true only on `ℚ` because of the norm
